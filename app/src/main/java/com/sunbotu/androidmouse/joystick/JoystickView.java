...
public class JoystickView extends View {
    ...
    private JoystickMoveListener moveListener;
    private JoystickClickListener clickListener;
    ...
    public void setOnJoystickMovedListener(JoystickMoveListener listener) {
        this.moveListener = listener;
    }

    public void setOnJoystickClickedListener(JoystickClickListener listener) {
