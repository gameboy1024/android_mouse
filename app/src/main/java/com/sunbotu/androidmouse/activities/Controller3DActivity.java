...
public class Controller3DActivity extends Activity {
    private static final String PREF_SENSIBILITY = "sensibility_3d";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_controller_3d);
